...
function draw() {
  ...
  strokeWeight(0.5);
  fill(0);
  text("If you are near,Press A to change the animation to eliminate the ghosts" ,550,60 );

  textSize(13);
  stroke(0);
  strokeWeight(0.5);
  fill(0);
  text("Press W to change the Ghosts' animation", 600,80);
